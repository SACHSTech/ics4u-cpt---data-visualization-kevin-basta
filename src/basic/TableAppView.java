...
public class TableAppView extends Application {
    ...
    private void setSelectedStringCatagory(String strCatagory) throws IOException {
        if (strCatagory == "Cars") {
            companyDataList = CompanyList.sortByCatagory(6, "Cars");
        } else if (strCatagory == "Bank") {
            companyDataList = CompanyList.sortByCatagory(6, "Bank");
        } else if (strCatagory == "Utility") {
            companyDataList = CompanyList.sortByCatagory(6, "Utility");
        } else if (strCatagory == "Conglomerate") {
            companyDataList = CompanyList.sortByCatagory(6, "Conglomerate");
        } else if (strCatagory == "Trade") {
            companyDataList = CompanyList.sortByCatagory(6, "Trade");
        } else if (strCatagory == "Technology") {
            companyDataList = CompanyList.sortByCatagory(6, "Technology");
        } else if (strCatagory == "Food and drink") {
            companyDataList = CompanyList.sortByCatagory(6, "Food and drink");
        } else if (strCatagory == "Transport") {
            companyDataList = CompanyList.sortByCatagory(6, "Transport");
        } else if (strCatagory == "Retail") {
            companyDataList = CompanyList.sortByCatagory(6, "Retail");
        } else if (strCatagory == "Pharmacy") {
            companyDataList = CompanyList.sortByCatagory(6, "Pharmacy");
        } else if (strCatagory == "Manufacture") {
            companyDataList = CompanyList.sortByCatagory(6, "Manufacture");
        } else if (strCatagory == "Real Estate") {
            companyDataList = CompanyList.sortByCatagory(6, "Real Estate");
        } else if (strCatagory == "Insurance") {
            companyDataList = CompanyList.sortByCatagory(6, "Insurance");
        } else if (strCatagory == "Entertainment") {
            companyDataList = CompanyList.sortByCatagory(6, "Entertainment");
        } else if (strCatagory == "Construction") {
            companyDataList = CompanyList.sortByCatagory(6, "Construction");
        } else if (strCatagory == "Media") {
            companyDataList = CompanyList.sortByCatagory(6, "Media");
        } else if (strCatagory == "Convenience ") {
            companyDataList = CompanyList.sortByCatagory(6, "Convenience ");
        } else {
            companyDataList = CompanyList.getArrayList();
        }
    }
    ...
    public Parent createContent() throws IOException {
        ...
        tableView.getColumns().addAll(globalRank, companyName, companySales, companyProfits, companyAssets,
